...
export default function IncidentMap({
	...
	return (
		...
		>
			...
			<div className="absolute bottom-4 right-4 z-10 w-56 rounded-lg border border-slate-200 bg-white p-4 shadow-xl">
				{layerMode === "heatmap" ? (
					<>
						...
						<div className="mt-3 space-y-1.5 border-t border-slate-100 pt-3 text-xs text-slate-600">
							...
							<div className="flex items-center justify-between border-t border-slate-100 pt-2">
								...
								<span className="font-bold text-slate-800">{activeUnitCount}</span>
							</div>
						</div>
					</>
				) : (
